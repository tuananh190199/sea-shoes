...
<body>
    ...
    <form action="pay"  method="post" class="form-content">
        ...
        <div  class="container" style="display: flex; flex-direction: column;">
            ...
            <input id ="str" type="text" name="hoadon">
      </div>
								...
								<div class="col-2-6">
									<div class="widget-ft first">
										...
										<div class="collapse" id="collapseListMenu01">
											<ul class="list-menu">
												<li class="li_menu"><a href="index.jsp">Trang chủ</a></li>
												<li class="li_menu"><a href="about.jsp">Giới thiệu</a></li>
							...
							<div class="widget-ft">
								...
								<div class="footer-widget">
									<a href="/" class="bocongthuong">					
										<img src="cart/bocongthuong.png" alt="Sea Shoes">					
									</a>
								</div>
								...
								<div class="time_work">
									<ul class="list-menu">
										<li class="li_menu li_menu_xxx">
											<a href="/" class="bocongthuong">					
												<img src="cart/payment.png" alt="Sea Shoes">					
											</a>
										</li>
									</ul>
								</div>
