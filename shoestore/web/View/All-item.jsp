						...
						<div class="row row__col-6-menu">
							<nav class="nav-menu">
								<ul class="nav-menu nav-menu__full">
									...
									<li
										class="nav-menu-item nav-menu-item--after nav-menu-item-hover active">
	...
	<div class="title-about">
		<div class="content-title">
			...
			<div class="desition-title">
				<ul>
					<li><a href="#" class="content-link"><form
								action="show_Index" method="get">Trang chủ</form></a></li>
					<li>/</li>
					<li><a href="#" class="content-link"><form
								action="show_All_Item" method="get">Sản phẩm</form></a></li>
				</ul>
			</div>
	...
	<div class="sidebar">
		<div class="searchTitleBar" style="margin-left: 1%">
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="#"><form action="show_GiayTheThao" method="get">Thể
							thao</form></a> <a href="#"><form action="show_GiayChayBo" method="get">Chạy
							bộ</form></a> <a href="#"><form action="show_GiayDaBong" method="get">Đá
							bóng</form></a>
				</div>
			</div>
		</div>
		<div class="searchTitleBar">
			<div class="dropdown">
				...
				<div class="dropdown-content">
					...
					<a href="#"><form action="show_GiayThuongDinh" method="get">Thượng
							Đình</form></a>
				</div>
			</div>
		</div>
		<div class="searchTitleBar" style="margin-right: 1%">
			<div class="dropdown">
				...
				<div class="dropdown-content">
					<a href="#"><form action="sort_az" method="get">A-Z</form></a> <a
						href="#"><form action="sort_GiaTangDan" method="get">Giá
							tăng dần</form></a> <a href="#"><form action="sort_GiaGiamDan"
							method="get">Giá giảm dần</form></a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="brand">
					<a href="#">
						<form action="show_TheoThuongHieu" method="get">
							<input type="hidden" name="brandShoes"
								value="<%=i.getThuongHieu()%>">
							<%=i.getThuongHieu()%>
						</form>
					</a>
				</div>
