                ...
                <div class="left">
                    ...
                    <div class="left__content">
                        ...
                        <ul class="left__menu">
                            ...
                            <li class="left__menuItem">
                                <a href="#" class="left__title"><form action="Admin_customer" method="get"></form><img src="assets/icon-users.svg" alt="">Khách Hàng</a>
                            </li>
                            <li class="left__menuItem">
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    <a class="left__link" href="#"><form action="show_admin_add_user" method="get">Thêm Admin</form></a>
                ...
                <div class="right">
                    <div class="right__content">
                        ...
                        <div class="right__cards">
                            ...
                            <a class="right__card" href="#">
                                <form action="Admin_customer" method="get">
